...
class Camera():
    ...
    def _load_triangles(self):
        ...
        map_values = torch.load(os.path.join(absolute_path, "../terrain_data/knn_terrain/map_values.pt"))
    ...
    def _load_triangles_with_indices(self):
        ...
        absolute_path = os.path.dirname(os.path.abspath(__file__))
        map_indices = torch.load(os.path.join(absolute_path, "../terrain_data/knn_terrain/map_indices.pt"))
