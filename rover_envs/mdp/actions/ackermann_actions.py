...
class AckermannAction2(ActionTerm):
    ...
    def ackermann(self, lin_vel, ang_vel):
        ...
        wl = (torch.ones_like(r_FL) * wl) / 2  # Repeat wl as tensor
...
class AckermannAction3():
    ...
    def __init__(self,
        ...
        # We want to map the joint names to the following order
