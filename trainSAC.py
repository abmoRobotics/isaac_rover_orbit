...
from skrl.agents.torch.sac import SAC, SAC_DEFAULT_CONFIG  # noqa: E402
...
from rover_envs.utils.config import convert_skrl_cfg, parse_skrl_cfg  # noqa: E402 F401
...
def main():
    ...
    experiment_cfg = parse_skrl_cfg("Rover-v0SAC")
